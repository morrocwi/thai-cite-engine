...
> **ระดับความมั่นใจปัจจุบัน (มาตรวัดของโปรเจกต์เอง): `Dr` — สถาปัตยกรรมที่มีเหตุผลรองรับ ผ่าน unit test 79/79 ตัว แต่ยังไม่ใช่ "ระบบที่พิสูจน์แล้วว่าดีกว่า" จนกว่าจะผ่าน live adversarial test เต็มรูปแบบ**
...
**Adapter จริงที่ใช้งานได้แล้ว:** OpenAlex, Crossref, PubMed (ยืนยันด้วย live request จริง) — ThaiJO เขียนโค้ดครบแล้วแต่ endpoint พื้นฐานยังไม่ยืนยันสด (ดู KNOWN_ISSUES.md)
